            ...
            ?>
                ...
                <div class="admin-form-card">
                    <form method="POST" action="admin-tours.php?action=edit&id=<?php echo $tour_id; ?>" enctype="multipart/form-data">
                        <input type="hidden" name="old_image" value="<?php echo htmlspecialchars($edit_tour['image_url']); ?>">

                        <div class="form-group">
                            <label>Tour Image</label>
                            <?php if (!empty($edit_tour['image_url'])): ?>
                                <img src="<?php echo htmlspecialchars($edit_tour['image_url']); ?>" alt="Current" class="current-img">
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php while ($t = mysqli_fetch_assoc($tours_list)): ?>
                                <tr>
                                    <td><img src="<?php echo htmlspecialchars($t['image_url']); ?>" alt="" class="tour-thumb"></td>
